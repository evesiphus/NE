...
TR = zeros(n_1,n_2); 
TR_NE = zeros(n_1,n_2);
Price_of_Anarchy = zeros(1,length(Q));
Price_of_S = zeros(1,length(Q));
Number_of_NE = zeros(1,length(Q));
TR_1=zeros(1,length(Q));
TR_2=zeros(1,length(Q));
for kk = 1:1:length(Q)
